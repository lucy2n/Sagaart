    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[(1, 'Male'), (2, 'Female')], max_length=128, verbose_name='Пол')),
                ...
                ('professional_education', models.CharField(blank=True, max_length=128, verbose_name='Художественное образование')),
                ...
                ('personal_style', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='objauthor', to='artobjects.style', verbose_name='Персональный стиль')),
            ],
            options={
                'verbose_name': 'Автор',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(blank=True, max_length=128, verbose_name='Страна товара')),
                ('city_sale', models.CharField(max_length=128, verbose_name='Город продажи')),
                ('year', models.PositiveIntegerField(verbose_name='Год создания')),
                ('material', models.CharField(blank=True, max_length=128, verbose_name='Материал работы')),
                ...
                ('cost_category', models.IntegerField(choices=[(1, 'до 20 000 руб.'), (2, 'от 20 000 до 50 000 руб.'), (3, '50 000 до 100 000 руб.'), (4, 'от 100 000 до 200 000 руб.'), (5, 'от 200 000 до 500 000 руб.')], verbose_name='Категория цены')),
                ('end_cost', models.PositiveIntegerField(verbose_name='Итоговая цена')),
                ('fair_cost', models.PositiveIntegerField(blank=True, verbose_name='Желаемая цена')),
