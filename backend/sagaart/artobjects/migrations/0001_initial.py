    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "place",
                    models.CharField(max_length=50, verbose_name="Место"),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "city_of_birth",
                    models.CharField(
                        max_length=50, null=True, verbose_name="Город рождения"
                    ),
                ),
                (
                    "city",
                ...
                (
                    "education",
                    models.CharField(
                        max_length=50, null=True, verbose_name="Образование"
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "size",
                    models.CharField(max_length=50, verbose_name="Размер"),
                ),
                (
                    "size_category",
                    models.IntegerField(
                ...
                (
                    "year",
                    models.PositiveIntegerField(verbose_name="Год создания"),
                ),
                (
                    "sale_city",
                    models.CharField(
                        max_length=50, verbose_name="Город продажи"
                    ),
                ),
                (
                    "material",
                    models.CharField(
                        max_length=50, verbose_name="Материал объекта"
                    ),
                ),
                (
                    "tablet_material",
                    models.CharField(
                        max_length=50, verbose_name="Материал планшета"
                    ),
                ),
                (
                    "description",
                ...
                (
                    "end_cost",
                    models.IntegerField(verbose_name="Финальная цена"),
                ),
