        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "education",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="Образование"
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "size",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="Размер"
                    ),
                ),
                (
                    "country",
                ...
                (
                    "city_sale",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="Город продажи"
                    ),
                ),
                (
                    "year",
                ...
                (
                    "material",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="Материал"
                    ),
                ),
                (
                    "tablet_material",
                ...
                (
                    "description",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="Описание"
                    ),
                ),
                (
                    "cost_category",
