...
class ArtObject(models.Model):
    ...
    size = models.CharField(
        verbose_name="Размер", max_length=CHARFIELD_MAX_LEN
    )
...
class ObjectAuthor(models.Model):
    ...
    city_of_birth = models.CharField(
        null=True, max_length=CHARFIELD_MAX_LEN, verbose_name="Город рождения"
    )
    ...
    education = models.CharField(
        null=True, max_length=CHARFIELD_MAX_LEN, verbose_name="Образование"
    )
    ...
    socials = models.CharField(
        null=True, max_length=CHARFIELD_MAX_LEN, verbose_name="Социальные сети"
    )
