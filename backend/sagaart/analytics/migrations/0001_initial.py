    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('art_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='artobjects.artobject')),
                ('object_author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='artobjects.objectauthor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='artobjects.objectauthor', verbose_name='Автор')),
            ],
        ),
    ]
